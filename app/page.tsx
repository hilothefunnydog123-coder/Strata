...
export default function OverviewPage() {
  ...
  const attention = systemsNeedingAttention().slice(0, 5);
          ...
          <div className="space-y-4 lg:col-span-4">
            <Panel>
              ...
              <PanelBody>
                ...
                <p className="mt-4 border-t border-edge pt-3 text-xs leading-relaxed text-fg-muted">
                  {estate.riskCounts.High + estate.riskCounts.Critical} systems are
                  classified High or Critical risk and carry mandatory clinical review and
                  accelerated validation cadence.
                </p>
              </PanelBody>
            </Panel>
            ...
            <Panel>
              <PanelHeader
                ...
                description="Prioritized by operational severity."
              />
            ...
            <Panel>
              <PanelHeader
                ...
                description="Governance and operational events."
              />
              <PanelBody>
